...
namespace DOAN
{
    ...
    class DSCD2 : RANKING
    {
        ...
        public void them()
        {
            ...
            ng[ng.Length - 1].nhap();
            ng[ng.Length - 1].Giatri = SURVIVE.Level;
        }
        public void ghifile()
        {
            System.IO.FileStream fw = new System.IO.FileStream(@"../../DSCD2.txt", FileMode.Create, FileAccess.Write);
        ...
        public void docfile()
        {
            ...
            if (File.Exists(@"../../DSCD2.txt") == false) fr = new System.IO.FileStream(@"../../DSCD2.txt", FileMode.Create);
            else
